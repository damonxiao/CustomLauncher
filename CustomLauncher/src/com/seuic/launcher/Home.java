...
import com.seuic.launcher.widget.ApplicationsStackLayout;
...
public class Home extends Activity {
    ...
    private static LinkedList<AppInfo> mFavorites;
    ...
    private void bindRecents() {
        ...
        final ArrayList<AppInfo> recents = new ArrayList<AppInfo>();
        ...
        for (int i = count - 1; i >= 0; i--) {
            ...
            if (Intent.ACTION_MAIN.equals(intent.getAction()) &&
                ...
                AppInfo info = getApplicationInfo(manager, intent);
                if (info != null) {
                    info.setIntent(intent);
    ...
    private static AppInfo getApplicationInfo(PackageManager manager, Intent intent) {
