...
public class ColorPickerDialog extends Dialog {
    ...
    private class ColorPickerView extends View {
        ...
        public ColorPickerView(Context context, int height, int width) {
            ...
            // 黑白渐变参数
            mRectColors = new int[] {
                    0xFF000000, mCenterPaint.getColor(), 0xFFFFFFFF
            };
                ...
                case MotionEvent.ACTION_MOVE:
                    if (downInCircle && inCircle) {// down按在渐变色环内, 且move也在渐变色环内
                        ...
                        mCenterPaint.setColor(interpCircleColor(mCircleColors, unit));
                            Logger.v(TAG, "色环内, 坐标: " + x + "," + y);
                    } else if (downInRect && inRect) {// down在渐变方块内,
                                                      // 且move也在渐变方块内
                        mCenterPaint.setColor(interpRectColor(mRectColors, x));
                    }
                        Logger.v(TAG, "[MOVE] 高亮: " + highlightCenter + "微亮: " + highlightCenterLittle
                                + " 中心: " + inCenter);
