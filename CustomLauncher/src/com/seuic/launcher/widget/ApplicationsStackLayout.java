...
import com.seuic.launcher.R.layout;
import com.seuic.launcher.R.styleable;
...
public class ApplicationsStackLayout extends ViewGroup implements View.OnClickListener {
    ...
    private int stackApplications(List<AppInfo> applications, int childLeft, int childTop) {
        ...
        for (int i = count - 1; i >= 0; i--) {
            final AppInfo info = applications.get(i);
     ...
     */
    public void setFavorites(List<AppInfo> applications) {
     ...
     */
    public void setRecents(List<AppInfo> applications) {
